...
> 来源：[Founder Park](https://mp.weixin.qq.com/s/8oUv5H9qvjpq_-aCiJ9f6A) | 作者：Yangqi（海外独角兽） | 抓取时间：2026-05-21

---

5 月初，Anthropic 和 OpenAI 在同一天分别宣布成立了企业服务公司。Anthropic 联手黑石、高盛等，成立了估值 15 亿美元的企业服务合资公司；OpenAI 也被曝正在筹建一家名为 The Development Company 的新公司，计划从 19 家投资者处筹集 40 亿美元，估值 100 亿美元。

两家方向不同、出资方不重叠，但支撑它们的核心组织形式，都是 Palantir 推广的 Forward-Deployed Engineer（前沿部署工程师，FDE）模式。

同样，据 Business Insider 报道，FDE 相关岗位从 2025 年 4 月的 643 个，飙升到 2026 年 4 月的 5330 个，同比增长了近 729%。Anthropic、OpenAI、Palantir、Stripe、Google Cloud 都在抢人。

最近，FDE 几乎成为了科技行业最抢手的工作，也是 AI 落地中最关键的角色。

为什么 agent 时代所有人都在抢 FDE？

因为客户买的不是软件，而是一个「能干活的 agent」。PMF 更多发生在客户的真实业务现场，FDE 直接驻场，理解客户的数据、流程、痛点，然后把通用模型打磨成能跑业务的具体方案。他们既是工程师，也是产品经理、解决方案架构师，甚至算是半个咨询顾问。

FDE 这个岗位是怎么被设计出来的？Palantir 内部是如何选人、搭团队、驱动产品的？

这篇文章，是前 Palantir 高管、前 OpenAI 首席研究官 Bob McGrew 关于 FDE 模式的一次深度复盘。作为 Palantir 的第二位工程师，Bob 完整经历了 FDE 模式从 0 到 1 的诞生，也亲手参与了产品构建、人才筛选和团队搭建的每一步。

在这篇内容中，他系统拆解了 Palantir 的 FDE 模式到底是什么，以及为什么它会在今天这个 AI agent 时代，成为创业公司值得重新审视的组织样本。
...
我们发现每家客户要的东西都有所区别，与其给每一家单独做一个版本，或者补一堆只适用于特定一家客户的功能，不如把产品做成高度可定制的平台，这样一来，就必须把员工派驻到现场，深入理解用户并做本地化改造。
...
**Host：在 Palantir 是工程师们直接面向企业客户而非专业销售，这是怎么形成的？** 尤其当我们面对的客户是政府和国防部门时，大多数人会倾向于去雇佣一批经验丰富的、长期和政府官员打交道的销售人员，但 Palantir 并没有这么做？
...
**Host:** 这两个角色的有趣之处在于，他们是完全不同类型的人，有不同的背景。你如何找到合适的人来担任这些角色，因为不是随便一个普通工程师就能胜任 FDE 的，他们需要更多与用户交谈的能力，或者 Echo 团队也需要更强的技术背景，而不仅仅是客户经理。**Palantir 是如何建立 FDE 团队的？**

**Bob:** Echo 团队的理想人才画像是某个领域的专家。比如可能是一位前陆军军官，或者是在医疗保健领域有深度工作经验的人。他们有深厚的领域知识。除此之外，还有一点非常重要，Echo 团队成员需要具备「反叛者（rebel）」的特质，Shyam 甚至会称他们为「异端（heretics）」，这些人不仅了解现有的做事方式，而且能够认识到这种方式不够好的点在哪里。因为如果看不到问题，就永远无法想出新软件以及它们带来的那种阶跃式变化。
...
- **Anduril**（国防科技）— 创始人 Trae Stephens、Matt Grimm、Brian Schimpf 均为 Palantir 校友，2025 年 6 月估值约 305 亿美元
- **Hex**（数据分析协作平台）— 创始人 Barry McCardel、Caitlin Colgrove、Glen Takahashi 均为 Palantir 校友
- **Peregrine**（公共安全数据平台）— 创始人 Nick Noone 曾领导 Palantir 的特种作战业务，2025 年 3 月融资后估值约 25 亿美元
- **Chapter**（医保导航与经纪平台）— 创始人 Cobi Blumenfeld-Gantz 为 Palantir 校友
- **ElevenLabs**（AI 语音公司）— 联合创始人 Mati/Mateusz Staniszewski 为前 Palantir FDE
- **Ironclad**（数字合约平台）— 联合创始人 Cai GoGwilt 为前 Palantir 工程师
- **Angle Health**（数字化健康险）— 创始人 Ty Wang 与 CTO Anirban Gangopadhyay 均为 Palantir 工程师出身
- **Blend**（金融科技）— 创始人 Nima Ghamsari 早年就职于 Palantir
- **Sourcegraph**（开发者工具公司）— CTO Beyang Liu 曾在 Palantir 任工程师
- **RelateIQ**（销售智能公司）— 联合创始人 Adam Evans 曾在 Palantir 创建健康业务

你说的很对，FDE 团队在每个客户现场所做的事情确实有点像是一个创始人，但 FDE 成员的区别是他们可以接触到一些非常强大的产品杠杆（product leverage）的创始人，这让你的工作更容易。我认为这是很好的培训，这也可能是为什么市场上现在会看到这么多来自 Palantir 的创始人。

---

## 03 FDE 不是咨询，做通用产品同样重要

**Host:** 那些不太了解 FDE 的人经常会说：「这只是用花哨的营销话术包装起来的咨询业务。」为什么这种说法是错的？

**Bob:** 客观来说 FDE 确实存在着成为那种情况的风险。如果在 2015 年和人们谈论 Palantir，你可能会主要听到两件事：

1. 第一，Palantir 是邪恶的（Palantir is evil）（备注：Palantir 早期和情报部门合作，做的是间谍有关的业务），
2. 第二，这是一个永远无法规模化的咨询业务，它不是一个软件公司，而是咨询公司。

在过去我们其实花了很多时间试图理解这种评价是否正确。

从商业模式上，我们会看到的一个关键趋势是：当我们去一个新客户那里做新项目部署时，在一开始我们可能实际上是在亏钱的，但随着我们在客户那里待的时间变长，我们的产品因为产品探索而变得更适合客户的需求，从而我们不再需要一个庞大的团队在客户现场搞清楚客户需要什么。同时会像 Shyam 所说的那样，我们会逐渐赢得接触客户现场的更重要问题的权利。
...
**Bob:** Palantir 有两个核心团队，一个是 FDE 团队，另一个是产品管理（product management）团队。
...
一个典型的失败例子就是，FDE 为一个客户实现了一些东西，然后就直接把它引入到所有产品中。结果是 FDE 构建的东西对于其他客户来说过于特化了。这里的关键在于拥有能够构建更通用产品的能力的产品人员。
...
**Host:** 现在 Ontology 是如何运作的？是有一个包含像人和钱这样通用可复用对象的基础数据库模式（database schema），然后根据每个站点进行定制吗？
...
Palantir 的市场不是一个单一连贯的市场，我们与国家情报机构、国家执法机构、军方合作。尽管所有这些组织都有一些类似的项目，但即使是反扩散工作流程（counterproliferation workflow）和反恐工作流程（counterterrorism workflow）之间，也存在巨大差异，一个是查明谁在制造核弹，一个是查明谁在制造简易爆炸装置，它们在运作方式上实际上有很大的不同。
...
但当对于 AI agent，没有现成的产品。构建 AI agent 实际上可能意味着很多不同的事情，而我们还不知道那些是什么，我们得去弄清楚。甚至可能五年后我们回过头来看，会觉得 AI agent 根本就不是一回事，我们实际上在做所有这些不同的事情。
...
其中一个关键的区别，也是我认为人们很难理解的一点是：如何选择一个问题，然后如何为那个问题定价。从根本上说，用 FDE 模式销售的不是具体某个软件的安装过程，你销售的是一个成果。就像 Shyam 会说的，你销售的是你解决了一个问题。
...
**Host:** 一些 YC 公司也开始这样做了，比如 Castle 是为银行客户提供抵押贷款服务的 AI 语音 agent，他们把成功处理所有这些抵押贷款请求的电话数量作为衡量成果，合同规模也在逐步增加。Happy Robot 主要是做物流领域的 AI 语音 agent，和 DHL 这样的大公司合作，情况类似。
...
但真正令人震惊的是，AI 采用速度（adoption）远没有能力进展快。极大可能是，未来 5 年世界 AI 能力不断飞速前进，但我们在现实世界却感觉越来越平庸。就像现在我们坐在 Waymo 里不会想「天哪，无人驾驶已经实现了！」，而是「交通真堵，真慢」。
